...
cls
echo.
echo Installing Pixelator.dll to %PDN_DIR%\Effects\
echo.
copy /y "Pixelator.dll" "%PDN_DIR%\Effects\"
if '%errorlevel%' == '0' (
goto success
) else (
goto fail
...
echo.
echo Installing Pixelator.dll to %PDN_DIR%\paint.net App Files\Effects\
echo.
mkdir "%PDN_DIR%\paint.net App Files\Effects\" 2>nul
copy /y "Pixelator.dll" "%PDN_DIR%\paint.net App Files\Effects\"
if '%errorlevel%' == '0' (
goto success
) else (
goto fail
